    ...
    public partial class logform : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                path = @"C:/Users/tomal/Documents/Visual Studio 2013/Projects/AllInfo/adminpropic/" + name+".jpg";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                path = @"C:/Users/tomal/Documents/Visual Studio 2013/Projects/AllInfo/facultypropic" + name + ".jpg";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (StudentLinqDataContext data = new StudentLinqDataContext())
                {
                    ...
                    Password = lg.CreatePassword;
                    name=lg.StudentName;
                    path = @"C:/Users/tomal/Documents/Visual Studio 2013/Projects/AllInfo/studentpropic/" + name + ".jpg";
